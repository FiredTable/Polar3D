...
class Logger:
    ...
    def _print_training_status(self):
        ...
        training_str = "[{:6d}, {:10.9f}] ".format(self.total_steps+1, self.scheduler.get_last_lr()[0])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default='ca-igev-stereo', help="name your experiment")
    parser.add_argument('--restore_ckpt', default=r'checkpoints_stereo\vits_cagwc\2025-09-26_22-18_sceneflow\ca-igev-stereo.pth')
    parser.add_argument('--logdir', default=r'checkpoints_stereo', help='the directory to save logs and checkpoints')
    ...
    args.logdir = os.path.join(args.logdir, args.encoder + '_' + args.corr_module, time_str+f'_{args.train_datasets}_wd{args.wdecay}')
